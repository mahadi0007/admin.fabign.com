...
export const Category2Form = (props) => {
  const {
    register,
    handleSubmit,
    setError,
  ...
  useEffect(() => {
    if (props.categoryData) {
      setValue("title", props.categoryData.title);
      setValue("title_image", props.categoryData.title_image);
      setValue("main_image", props.categoryData.main_image);
    }
  }, [props.categoryData]);
