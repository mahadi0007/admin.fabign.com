...
export const SearchWithSuggestions = forwardRef((props, ref) => {
  ...
  useImperativeHandle(ref, () => ({
    queryClear() {
      setQuery({ value: null, error: false });
    },
  }));
  ...
  return (
    <div className="search-component">
      ...
      <form onSubmit={onSubmit}>
        <div className="input-container">
          <input
            ...
            className={
              query.error
                ? "form-control form-control-sm shadow-none error"
                : "form-control form-control-sm shadow-none"
            }
          />
      ...
      <div
        className={
          isTyping ? "suggestion-container" : "suggestion-container d-none"
        }
      >
        {result.message ? (
