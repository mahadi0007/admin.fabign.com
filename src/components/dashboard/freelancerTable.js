...
const FreelancerTable = () => {
    ...
    // fetch rop 5 freelancer data
    const fetchFreelancer = useCallback(async (page) => {
        try {
            setLoading(true)
        ...
        <div>
            ...
            <Card.Simple className="border-0">
                <Card.Body className="p-0">
                    <Text className="fs-18 fw-bolder text-center mb-0 pt-2"> Top 5 Freelancer</Text>

                    {loading && !freelancerData.length > 0 ? <Loader /> : null}
