...
import AllOrder from "../../components/all-tailoring-order/allOrder";
import PendingOrder from "../../components/all-tailoring-order/pendingOrder";
import DeliveryOrder from "../../components/all-tailoring-order/deliveryOrder";
import BookedOrder from "../../components/all-tailoring-order/bookedOrder";
import CancelOrder from "../../components/all-tailoring-order/cancelOrder";
...
const Index = () => {
  ...
  const setDefaultDataValue = async () => {
    try {
      const response = await Requests.TailoringOrder.AllIndex();
