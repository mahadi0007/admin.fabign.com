...
import PendingOrder from "../../components/all-order/pendingOrder";
import DeliveryOrder from "../../components/all-order/deliveryOrder";
import BookedOrder from "../../components/all-order/bookedOrder";
import CancelOrder from "../../components/all-order/cancelOrder";
...
const Index = () => {
  ...
  const setDefaultDataValue = async () => {
    try {
      const response = await Requests.EOrder.AllIndex();
  ...
  return (
    <div>
      {/* Title bar */}
      <TitleBar
        mainTitle="Manage E-Order"
        subTitle="Manage your e-order"
        tag="Home / E-Order /"
        pageTag="Manage e-order"
      />
      {/* Order Section */}
      ...
      <Container.Column className="text-end">
        <Link to={"/dashboard/e-order/store"}>
          <PrimaryButton className="px-4 mb-3">
            <Text className="fs-15 mb-0">Add Order</Text>
          </PrimaryButton>
        </Link>
      </Container.Column>
