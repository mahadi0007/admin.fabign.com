...
const Show = () => {
  ...
  const fetchData = useCallback(async () => {
    const response = await Requests.EOrder.Show(id);
  ...
  const handlePaymentAction = async () => {
    ...
    await Requests.EOrder.UpdatePaymentStatus(id, paymentStatus.value);
    fetchData();
  ...
  const onCancelItem = async () => {
    ...
    const response = await Requests.EOrder.ItemCancelation(formData, id);
    fetchData();
