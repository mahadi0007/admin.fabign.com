...
const Show = () => {
  ...
  const fetchData = useCallback(async () => {
    const response = await Requests.TailoringSampleOrder.Show(id);
  ...
  const handleStatusAction = async (data) => {
    ...
    await Requests.TailoringSampleOrder.Update(
      { status: orderStatus.value },
      id
    );
  ...
  const handlePaymentAction = async () => {
    ...
    await Requests.TailoringSampleOrder.UpdatePaymentStatus(
      id,
      paymentStatus.value
    );
    fetchData();
  ...
  const onCancelItem = async () => {
    ...
    const response = await Requests.TailoringSampleOrder.ItemCancelation(
      formData,
      id
    );
    fetchData();
